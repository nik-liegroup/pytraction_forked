...
from tests.prelim_code.prelim_kernels import *
...
def traction_fourier(xx, yy, ux, uy, s, elastic_modulus, lambd=None, scaling_factor=None, zdepth=0, slim=False):
    x_val, y_val = xx[0, :], yy[:, 0]
    meshsize_x, meshsize_y = x_val[1] - x_val[0], y_val[1] - y_val[0]
    ...
    X = diff_operator(ft_gxx, ft_gxy, ft_gyy)

    return fx, fy, ft_fx, ft_fy, ft_ux, ft_uy, kxx, kyy, X
